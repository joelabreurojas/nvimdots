...
'@
	...
	info -Msg "This script will install j4breu/nvimdots to:"
	...
	if ($USE_SSH) {
		clone_repo -WithURL 'git@github.com:j4breu/nvimdots.git'
	} else {
		clone_repo -WithURL 'https://github.com/j4breu/nvimdots.git'
	}
...
- Project Homepage:
    https://github.com/j4breu/nvimdots
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
- Further documentation (including executables you |must| install for full functionality):
    https://github.com/j4breu/nvimdots/wiki/Prerequisites
    ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
'@
